"""
Django settings for tvitapp project.
...
SECRET_KEY = 'qcu5jkaq8qzpx*pzlm5*_@!byluic%_%od59^667vg6=meu1=t'
...
WSGI_APPLICATION = 'tvitapp.wsgi.application'
